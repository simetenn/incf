...
ax2 = ax.twinx()
ax2.plot(time, variance, color=colors[1], linewidth=2)
ax2.grid(False)
...
ax2.tick_params(axis="y", which="both", right="on", left="off", labelright="on", labelleft="off",
                color=colors[1], labelcolor=colors[1], labelsize=labelsize)

ax2.set_ylabel(r"Variance ($\mathrm{mV}$)", color=colors[1], fontsize=labelsize)
